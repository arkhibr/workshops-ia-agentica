...
Especificação, plano e testes que não se conectam num ciclo executável viram documentação que ninguém segue — cada artefato precisa alimentar o próximo automaticamente.
...
Executar um ciclo SDD completo com os modelos de especificação agênticas da Arkhi, do `constitution.md` ao código funcionando.
