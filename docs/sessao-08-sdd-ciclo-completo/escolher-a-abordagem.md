...
## Instalar ferramenta não cria governança
...
Uma resposta que aponta risco alto não obriga a adotar a ferramenta mais pesada. Obriga a cobrir o risco correspondente. Uma alteração irreversível num serviço pequeno pede plano de migração rigoroso, mas não necessariamente uma constitution de projeto.
