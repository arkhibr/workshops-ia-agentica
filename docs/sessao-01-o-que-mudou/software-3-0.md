...
[Andrej Karpathy](../referencia/bibliografia.md#karpathy-software-is-changing-again-2025) chamou de Software 3.0 a mudança em que o prompt em linguagem natural passa a ser o artefato que governa o comportamento do sistema. Esta página apresenta a tese, a curva de capacidade que a tornou prática e o que ela desloca no trabalho de quem desenvolve.

## Os três paradigmas

A arquitetura Transformer, descrita por [Vaswani et al. em 2017](../referencia/bibliografia.md#vaswani-et-al-attention-is-all-you-need-2017), é a base técnica de todo LLM usado hoje em ferramentas agênticas de codificação. Ela é o que torna prática a aprendizagem em contexto, e é sobre essa maturidade técnica que Karpathy constrói uma tese de fundo, apresentada na YC AI Startup School de 17 de junho de 2025.

A tese não nasceu isolada. Em 2017, no mesmo ano do artigo de Vaswani et al., Karpathy já havia publicado o ensaio ["Software 2.0"](../referencia/bibliografia.md#karpathy-software-20-2017), propondo que uma rede neural treinada é um tipo de programa diferente: em vez de escrito à mão em Python ou C++, ele é compilado a partir de dados por um processo de otimização. Software 3.0 estende essa mesma lógica um passo adiante. A programação teve, ao longo da história, um paradigma dominante por vez, e agora tem três coexistindo:
