...
5. **Piso, teto e julgamento humano sobem em ritmos diferentes.** "O código roda" e "o código está correto" são duas afirmações diferentes, e confundi-las é o erro mais caro desta lista.
