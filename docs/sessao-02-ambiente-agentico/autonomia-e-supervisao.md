...
A aritmética do erro composto, vista em [O arnês do agente](arnes.md#a-aritmetica-do-erro-composto), é o que dá tamanho a esse risco: numa trajetória de vinte etapas, 99% de acerto por etapa deixa a tarefa inteira em 81,8%. É por isso que autonomia ampla pede isolamento e verificação em vez de confiança no modelo.
...
A régua de autonomia e supervisão vista em [O que o ambiente deixa o agente decidir sozinho](autonomia-e-supervisao.md#o-que-o-ambiente-deixa-o-agente-decidir-sozinho) se decide caso a caso, e não uma vez para o time inteiro. Três perguntas ajudam:
