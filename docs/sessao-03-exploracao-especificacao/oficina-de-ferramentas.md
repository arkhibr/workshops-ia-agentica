...
**Esta é a oficina da trilha técnica.** Ela exige terminal, git e Node.js 20 ou superior, e termina com
testes executados. Quem conduz o mesmo ciclo sem escrever código faz a
[Oficina de negócio](oficina-de-negocio.md), que parte do mesmo pedido e chega à mesma especificação,
com verificação por retrotradução em vez de execução de teste.
...
- **Em seguida, na página própria:** os experimentos de entrevista socrática, que não usam código, ficam na [Oficina de entrevista socrática](oficina-de-entrevista.md).
