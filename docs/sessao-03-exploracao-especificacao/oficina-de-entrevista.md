...
Esta oficina serve às duas trilhas do workshop e não usa código em nenhum momento. Tudo o que ela
pede acontece numa conversa com o agente, em interface de chat ou em terminal, sem projeto montado,
sem repositório e sem execução de teste. Quem estiver na trilha técnica chega aqui depois da
[Oficina de ferramentas](oficina-de-ferramentas.md), e quem estiver na trilha de negócio chega depois
da [Oficina de negócio](oficina-de-negocio.md).

O trajeto vai de uma especificação ruim, recebida de um gerente comercial, até um dossiê que registra
o que a especificação escondia. O agente conduz a conversa por perguntas, e todas as respostas vêm de você.

## Ferramenta

Uma conversa nova com o agente que você já usa. Tempo estimado: 10 minutos para o Experimento C, que
é o essencial em aula, e mais 8 minutos para cada extensão.

**Decisão em foco:** descobrir o que uma especificação esconde sendo entrevistado sobre ela, em vez de
lendo-a de novo com mais atenção.

## Roteiro sugerido para a sessão

- **Essencial em aula:** Experimento C, a entrevista socrática sobre uma especificação ruim, conduzida
  em duplas formadas dentro da mesma trilha.
- **Exploração em dupla:** Experimento D, a mesma especificação analisada sem o contrato de entrevista.
- **Extensão para quem terminar antes:** Experimento E, o roteiro para entrevistar uma pessoa.

## Insumos dos experimentos

Os três experimentos usam o agente como entrevistador socrático, para expor os defeitos de uma especificação ruim sem que ele corrija nada por você.
...
Três itens, verificáveis pela conversa que você conduziu:

1. O dossiê do Experimento C, com o registro de proveniência e as perguntas abertas com dono.
2. A contagem de mensagens que violaram o contrato de uma única interrogação.
3. Uma frase respondendo qual informação o dossiê registrou que a análise direta do Experimento D não
   tinha como produzir.
